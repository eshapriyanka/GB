...
const SignIn = () => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Side - Information & Animation */}
      <motion.div 
      ...
      >
        ...
        <div className="absolute inset-0">
          ...
          />
          <motion.div 
            className="absolute top-60 right-20 w-24 h-24 bg-white/30 rounded-full blur-lg"
            variants={floatingVariants}
            animate="animate"
            transition={{ delay: 2 }}
          />
          <motion.div 
            className="absolute bottom-40 left-40 w-40 h-40 bg-white/10 rounded-full blur-2xl"
            variants={floatingVariants}
            animate="animate"
            transition={{ delay: 4 }}
          />
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-white p-12">
          ...
          >
            Continue your journey of learning, networking, and growing your future.
          </motion.p>
            ...
            <motion.div variants={itemVariants}>
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-black bg-gradient-to-r from-white/80 to-gray-300 bg-clip-text text-transparent">
                    Or continue with
                  </span>
                </div>
              </div>
